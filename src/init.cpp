...
bool AppInitParameterInteraction()
{
    ...
    nMaxConnections = std::max(std::min(nMaxConnections, (int)(1000000 - nBind - MIN_CORE_FILEDESCRIPTORS - MAX_ADDNODE_CONNECTIONS)), 0);
    ...
    if (nMaxConnections < nUserMaxConnections)
        InitWarning(strprintf(_("Reducing -maxconnections from %d to %d, because of system limitations %d."), nUserMaxConnections, nMaxConnections, nFD));
